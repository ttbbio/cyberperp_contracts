...
library Keys {
    ...
    bytes32 public constant QNTLV_LIST = keccak256(abi.encode("QNTLV_LIST"));
    bytes32 public constant QNTLV_DEPOSIT_LIST = keccak256(abi.encode("QNTLV_DEPOSIT_LIST"));
    bytes32 public constant QNTLV_SHIFT_LIST = keccak256(abi.encode("QNTLV_SHIFT_LIST"));
    bytes32 public constant ACCOUNT_QNTLV_DEPOSIT_LIST = keccak256(abi.encode("ACCOUNT_QNTLV_DEPOSIT_LIST"));
    bytes32 public constant QNTLV_WITHDRAWAL_LIST = keccak256(abi.encode("QNTLV_WITHDRAWAL_LIST"));
    bytes32 public constant ACCOUNT_QNTLV_WITHDRAWAL_LIST = keccak256(abi.encode("ACCOUNT_QNTLV_WITHDRAWAL_LIST"));
    bytes32 public constant QNTLV_SUPPORTED_MARKET_LIST = keccak256(abi.encode("QNTLV_SUPPORTED_MARKET_LIST"));
    ...
    bytes32 public constant CREATE_QNTLV_DEPOSIT_FEATURE_DISABLED = keccak256(abi.encode("CREATE_QNTLV_DEPOSIT_FEATURE_DISABLED"));
    bytes32 public constant CANCEL_QNTLV_DEPOSIT_FEATURE_DISABLED = keccak256(abi.encode("CANCEL_QNTLV_DEPOSIT_FEATURE_DISABLED"));
    bytes32 public constant EXECUTE_QNTLV_DEPOSIT_FEATURE_DISABLED = keccak256(abi.encode("EXECUTE_QNTLV_DEPOSIT_FEATURE_DISABLED"));

    bytes32 public constant CREATE_QNTLV_WITHDRAWAL_FEATURE_DISABLED = keccak256(abi.encode("CREATE_QNTLV_WITHDRAWAL_FEATURE_DISABLED"));
    bytes32 public constant CANCEL_QNTLV_WITHDRAWAL_FEATURE_DISABLED = keccak256(abi.encode("CANCEL_QNTLV_WITHDRAWAL_FEATURE_DISABLED"));
    bytes32 public constant EXECUTE_QNTLV_WITHDRAWAL_FEATURE_DISABLED = keccak256(abi.encode("EXECUTE_QNTLV_WITHDRAWAL_FEATURE_DISABLED"));

    bytes32 public constant CREATE_QNTLV_SHIFT_FEATURE_DISABLED = keccak256(abi.encode("CREATE_QNTLV_SHIFT_FEATURE_DISABLED"));
    bytes32 public constant EXECUTE_QNTLV_SHIFT_FEATURE_DISABLED = keccak256(abi.encode("EXECUTE_QNTLV_SHIFT_FEATURE_DISABLED"));
    ...
    bytes32 public constant QNTLV_DEPOSIT_GAS_LIMIT = keccak256(abi.encode("QNTLV_DEPOSIT_GAS_LIMIT"));
    bytes32 public constant QNTLV_WITHDRAWAL_GAS_LIMIT = keccak256(abi.encode("QNTLV_WITHDRAWAL_GAS_LIMIT"));
    bytes32 public constant QNTLV_SHIFT_GAS_LIMIT = keccak256(abi.encode("QNTLV_SHIFT_GAS_LIMIT"));
    bytes32 public constant QNTLV_PER_MARKET_GAS_LIMIT = keccak256(abi.encode("QNTLV_PER_MARKET_GAS_LIMIT"));
    ...
    bytes32 public constant QNTLV_MAX_MARKET_COUNT = keccak256(abi.encode("QNTLV_MAX_MARKET_COUNT"));
    bytes32 public constant QNTLV_MAX_MARKET_TOKEN_BALANCE_USD = keccak256(abi.encode("QNTLV_MAX_MARKET_TOKEN_BALANCE_USD"));
    bytes32 public constant QNTLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT = keccak256(abi.encode("QNTLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT"));
    bytes32 public constant IS_QNTLV_MARKET_DISABLED = keccak256(abi.encode("IS_QNTLV_MARKET_DISABLED"));
    bytes32 public constant QNTLV_SHIFT_MAX_PRICE_IMPACT_FACTOR = keccak256(abi.encode("QNTLV_SHIFT_MAX_PRICE_IMPACT_FACTOR"));
    bytes32 public constant QNTLV_SHIFT_LAST_EXECUTED_AT = keccak256(abi.encode("QNTLV_SHIFT_LAST_EXECUTED_AT"));
    bytes32 public constant QNTLV_SHIFT_MIN_INTERVAL = keccak256(abi.encode("QNTLV_SHIFT_MIN_INTERVAL"));
    bytes32 public constant MIN_QNTLV_TOKENS_FOR_FIRST_DEPOSIT = keccak256(abi.encode("MIN_QNTLV_TOKENS_FOR_FIRST_DEPOSIT"));
    ...
    // @dev key for the account qntlv deposit list
    // @param account the account for the list
    function accountQntlvDepositListKey(address account) internal pure returns (bytes32) {
        return keccak256(abi.encode(ACCOUNT_QNTLV_DEPOSIT_LIST, account));
    }

    // @dev key for the account qntlv deposit list
    // @param account the account for the list
    function accountQntlvWithdrawalListKey(address account) internal pure returns (bytes32) {
        return keccak256(abi.encode(ACCOUNT_QNTLV_WITHDRAWAL_LIST, account));
    }

    // @dev key for the qntlv supported market list
    // @param qntlv the qntlv for the supported market list
    function qntlvSupportedMarketListKey(address qntlv) internal pure returns (bytes32) {
        return keccak256(abi.encode(QNTLV_SUPPORTED_MARKET_LIST, qntlv));
    }
    ...
    function qntlvDepositGasLimitKey() internal pure returns (bytes32) {
        return QNTLV_DEPOSIT_GAS_LIMIT;
    }

    function qntlvWithdrawalGasLimitKey() internal pure returns (bytes32) {
        return QNTLV_WITHDRAWAL_GAS_LIMIT;
    }

    function qntlvShiftGasLimitKey() internal pure returns (bytes32) {
        return QNTLV_SHIFT_GAS_LIMIT;
    }

    function qntlvPerMarketGasLimitKey() internal pure returns (bytes32) {
        return QNTLV_PER_MARKET_GAS_LIMIT;
    }
    ...
    // @dev key for whether create qntlv deposit is disabled
    // @param the create deposit module
    // @return key for whether create deposit is disabled
    function createQntlvDepositFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            CREATE_QNTLV_DEPOSIT_FEATURE_DISABLED,
            module
        ));
    }

    // @dev key for whether cancel qntlv deposit is disabled
    // @param the cancel deposit module
    // @return key for whether cancel deposit is disabled
    function cancelQntlvDepositFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            CANCEL_QNTLV_DEPOSIT_FEATURE_DISABLED,
            module
        ));
    }

    // @dev key for whether execute qntlv deposit is disabled
    // @param the execute deposit module
    // @return key for whether execute deposit is disabled
    function executeQntlvDepositFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            EXECUTE_QNTLV_DEPOSIT_FEATURE_DISABLED,
            module
        ));
    }

    // @dev key for whether create qntlv withdrawal is disabled
    // @param the create withdrawal module
    // @return key for whether create withdrawal is disabled
    function createQntlvWithdrawalFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            CREATE_QNTLV_WITHDRAWAL_FEATURE_DISABLED,
            module
        ));
    }

    // @dev key for whether cancel qntlv withdrawal is disabled
    // @param the cancel withdrawal module
    // @return key for whether cancel withdrawal is disabled
    function cancelQntlvWithdrawalFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            CANCEL_QNTLV_WITHDRAWAL_FEATURE_DISABLED,
            module
        ));
    }

    // @dev key for whether execute qntlv withdrawal is disabled
    // @param the execute withdrawal module
    // @return key for whether execute withdrawal is disabled
    function executeQntlvWithdrawalFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            EXECUTE_QNTLV_WITHDRAWAL_FEATURE_DISABLED,
            module
        ));
    }

    function createQntlvShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            CREATE_QNTLV_SHIFT_FEATURE_DISABLED,
            module
        ));
    }

    function executeQntlvShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            EXECUTE_QNTLV_SHIFT_FEATURE_DISABLED,
            module
        ));
    }
   ...
   function virtualInventoryForSwapsKey(bytes32 virtualMarketId, bool isLongToken) internal pure returns (bytes32) {
    ...
    function qntlvMaxMarketTokenBalanceUsdKey(address qntlv, address market) internal pure returns (bytes32) {
        return keccak256(abi.encode(QNTLV_MAX_MARKET_TOKEN_BALANCE_USD, qntlv, market));
    }

    // @dev key for max market token balance amount
    // it is used to limit amount of funds deposited into each market
    function qntlvMaxMarketTokenBalanceAmountKey(address qntlv, address market) internal pure returns (bytes32) {
        return keccak256(abi.encode(QNTLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT, qntlv, market));
    }

    // @dev key for is qntlv market disabled
    function isQntlvMarketDisabledKey(address qntlv, address market) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            IS_QNTLV_MARKET_DISABLED,
            qntlv,
            market
        ));
    }

    // @dev key for max allowed price impact for qntlv shifts
    // if effective price impact exceeds max price impact then qntlv shift fails
    function qntlvShiftMaxPriceImpactFactorKey(address qntlv) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            QNTLV_SHIFT_MAX_PRICE_IMPACT_FACTOR,
            qntlv
        ));
    }

    // @dev key for time when qntlv shift was executed last
    // used to validate qntlv shifts are not executed too frequently
    function qntlvShiftLastExecutedAtKey(address qntlv) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            QNTLV_SHIFT_LAST_EXECUTED_AT,
            qntlv
        ));
    }

    // @dev key for min time interval between qntlv shifts in seconds
    function qntlvShiftMinIntervalKey(address qntlv) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            QNTLV_SHIFT_MIN_INTERVAL,
            qntlv
        ));
    }

    function minQntlvTokensForFirstQntlvDepositKey(address qntlv) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            MIN_QNTLV_TOKENS_FOR_FIRST_DEPOSIT,
            qntlv
        ));
    }
