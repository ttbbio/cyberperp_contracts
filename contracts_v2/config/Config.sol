...
contract Config is ReentrancyGuard, RoleModule, BasicMulticall {
    ...
    function initOracleProviderForToken(
        address oracle,
        address token,
        address provider
    ...
    function setDataStream(
        ...
        validateRange(Keys.DATA_STREAM_SPREAD_REDUCTION_FACTOR, abi.encode(token), spreadReductionFactor);
        ...
        dataStore.setUint(Keys.dataStreamSpreadReductionFactorKey(token), spreadReductionFactor);
        ...
        eventData.uintItems.initItems(1);
        eventData.uintItems.setItem(0, "dataStreamSpreadReductionFactor", spreadReductionFactor);
    ...
    function setUint(bytes32 baseKey, bytes memory data, uint256 value) external onlyKeeper nonReentrant {
        ...
        validateRange(baseKey, data, value);
    ...
    function _initAllowedBaseKeys() internal {
        ...
        allowedBaseKeys[Keys.CREATE_QNTLV_DEPOSIT_FEATURE_DISABLED] = true;
        allowedBaseKeys[Keys.CANCEL_QNTLV_DEPOSIT_FEATURE_DISABLED] = true;
        allowedBaseKeys[Keys.EXECUTE_QNTLV_DEPOSIT_FEATURE_DISABLED] = true;

        allowedBaseKeys[Keys.CREATE_QNTLV_WITHDRAWAL_FEATURE_DISABLED] = true;
        allowedBaseKeys[Keys.CANCEL_QNTLV_WITHDRAWAL_FEATURE_DISABLED] = true;
        allowedBaseKeys[Keys.EXECUTE_QNTLV_WITHDRAWAL_FEATURE_DISABLED] = true;

        allowedBaseKeys[Keys.CREATE_QNTLV_SHIFT_FEATURE_DISABLED] = true;
        allowedBaseKeys[Keys.EXECUTE_QNTLV_SHIFT_FEATURE_DISABLED] = true;
        ...
        allowedBaseKeys[Keys.QNTLV_DEPOSIT_GAS_LIMIT] = true;
        allowedBaseKeys[Keys.QNTLV_WITHDRAWAL_GAS_LIMIT] = true;
        allowedBaseKeys[Keys.QNTLV_SHIFT_GAS_LIMIT] = true;
        allowedBaseKeys[Keys.QNTLV_PER_MARKET_GAS_LIMIT] = true;
        ...
        allowedBaseKeys[Keys.IS_QNTLV_MARKET_DISABLED] = true;
        allowedBaseKeys[Keys.QNTLV_MAX_MARKET_TOKEN_BALANCE_USD] = true;
        allowedBaseKeys[Keys.QNTLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT] = true;
        allowedBaseKeys[Keys.QNTLV_SHIFT_MAX_PRICE_IMPACT_FACTOR] = true;
        allowedBaseKeys[Keys.QNTLV_SHIFT_MIN_INTERVAL] = true;
        allowedBaseKeys[Keys.MIN_QNTLV_TOKENS_FOR_FIRST_DEPOSIT] = true;
        allowedBaseKeys[Keys.QNTLV_MAX_MARKET_COUNT] = true;
    ...
    function validateRange(bytes32 baseKey, bytes memory data, uint256 value) public view {
