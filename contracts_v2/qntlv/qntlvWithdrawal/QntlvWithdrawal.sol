...
library QntlvWithdrawal {
    ...
    struct Addresses {
     ...
     // @param qntlvTokenAmount The amount of market tokens that will be withdrawn.
    ...
    function qntlvTokenAmount(Props memory props) internal pure returns (uint256) {
        return props.numbers.qntlvTokenAmount;
    }

    function setQntlvTokenAmount(Props memory props, uint256 value) internal pure {
        props.numbers.qntlvTokenAmount = value;
    }
