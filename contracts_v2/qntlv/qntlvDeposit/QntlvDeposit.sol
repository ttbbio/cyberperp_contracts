...
// @title QntlvDeposit
// @dev Struct for QNTLV deposits
library QntlvDeposit {
    ...
    // @param minQntlvTokens the minimum acceptable number of Qntlv tokens
    ...
    function minQntlvTokens(Props memory props) internal pure returns (uint256) {
        return props.numbers.minQntlvTokens;
    }

    function setMinQntlvTokens(Props memory props, uint256 value) internal pure {
        props.numbers.minQntlvTokens = value;
    }
