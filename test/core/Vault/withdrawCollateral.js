...
describe("Vault.withdrawCollateral", function () {
  ...
  it("withdraw collateral long", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("4985000000000000000000") // 4985
    expect(await cyberLPManager.getAumInUsdg(true)).eq("4985000000000000000000") // 4985
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("6726500000000000000000") // 6726.5
    expect(await cyberLPManager.getAumInUsdg(true)).eq("6726500000000000000000") // 6726.5
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("6726500000000000000500") // 6726.5000000000000005
    expect(await cyberLPManager.getAumInUsdg(true)).eq("6726500000000000000500") // 6726.5000000000000005

    await pyth.updatePrice(priceFeedIds.eth, toChainlinkPrice(400))
    await pyth.updatePrice(priceFeedIds.eth, toChainlinkPrice(400))
    await pyth.updatePrice(priceFeedIds.eth, toChainlinkPrice(400))

    expect(await cyberLPManager.getAumInUsdg(false)).eq("4171733333333333333600") // 4171.7333333333333336
    expect(await cyberLPManager.getAumInUsdg(true)).eq("4171733333333333333600") // 4171.7333333333333336
  ...
  it("withdraw collateral short", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("7976000000000000000000") // 7976
    expect(await cyberLPManager.getAumInUsdg(true)).eq("7976000000000000000000") // 7976
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("8076000000000000000000") // 8076
    expect(await cyberLPManager.getAumInUsdg(true)).eq("8076000000000000000000") // 8076
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("7876000000000000000000") // 7876
    expect(await cyberLPManager.getAumInUsdg(true)).eq("7876000000000000000000") // 7876
