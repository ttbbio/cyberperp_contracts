...
describe("Vault.increaseShortPosition", function () {
  ...
  it("increasePosition short", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq(0)
    ...
    expect(await globalDelta[0]).eq(false)
    expect(await globalDelta[1]).eq(0)
    expect(await cyberLPManager.getAumInUsdg(true)).eq("499800000000000000000")
    expect(await cyberLPManager.getAumInUsdg(false)).eq("499800000000000000000")
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("501995121951219512195") // 499.8 + 4.5
    expect(await cyberLPManager.getAumInUsdg(false)).eq("501995121951219512195") // 499.8 + 4.5
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("501995121951219512194") // 499.8 + 4.5
    expect(await cyberLPManager.getAumInUsdg(false)).eq("501995121951219512194") // 499.8 + 4.5
    ...
    expect(await globalDelta[0]).eq(false)
    expect(await globalDelta[1]).eq("975609756097560975609756097560")
    expect(await cyberLPManager.getAumInUsdg(true)).eq("501995121951219512194") // 502.3 + 2
    expect(await cyberLPManager.getAumInUsdg(false)).eq("501995121951219512194") // 502.3 + 2
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("496257607433217189314") // 502.3 + 1 - 4.76 => 498.53
    expect(await cyberLPManager.getAumInUsdg(false)).eq("496257607433217189314") // 492.77619047619047619
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("496257607433217189314") // 500.038095238095238095
    expect(await cyberLPManager.getAumInUsdg(false)).eq("496257607433217189314") // 492.77619047619047619
