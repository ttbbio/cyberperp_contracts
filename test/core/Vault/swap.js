...
describe("Vault.swap", function () {
  ...
  it("swap", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq(expandDecimals(59820, 18)) // 60,000 * 99.7%
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq(expandDecimals(119640, 18)) // 59,820 + (60,000 * 99.7%)
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("159520000000000000000000") // 59,820 / 300 * 400 + 59820
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("179460000000000000000000") // 59,820 / 300 * 400 + 59820 / 60000 * 80000
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("179460000000000000000000") // 159520 + (100 * 400) - 32000
