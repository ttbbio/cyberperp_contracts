...
describe("Vault.increaseLongPosition", function () {
  ...
  it("increasePosition long", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("46858400000000000000") // 48.02986
    expect(await cyberLPManager.getAumInUsdg(false)).eq("46858400000000000000") // 46.8584
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("93716800000000000000") // 96.05972
    expect(await cyberLPManager.getAumInUsdg(false)).eq("93716800000000000000") // 93.7168
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("93717000000000000000") // 95.10998
    expect(await cyberLPManager.getAumInUsdg(false)).eq("93717000000000000000") // 93.7182
  ...
  it("increasePosition long aum", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(expandDecimals(99700, 18))
    ...
    expect(await vault.getRedemptionCollateralUsd(btc.address)).eq(toUsd(99700))
    expect(await cyberLPManager.getAumInUsdg(true)).eq(expandDecimals(99700, 18))
    expect(await cyberLPManager.getAumInUsdg(false)).eq(expandDecimals(99700, 18))
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(expandDecimals(134510, 18)) // 30080 + (1.4962-0.8)*150000
    expect(await cyberLPManager.getAumInUsdg(false)).eq(expandDecimals(134510, 18)) // 30080 + (1.4962-0.8)*150000
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(expandDecimals(82295, 18)) // 30080 + (1.4962-0.8)*75000
    expect(await cyberLPManager.getAumInUsdg(false)).eq(expandDecimals(82295, 18)) // 30080 + (1.4962-0.8)*50000
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("82295000250000000000000") // 102295.0005
    expect(await cyberLPManager.getAumInUsdg(false)).eq("82295000250000000000000") // 68196.667
