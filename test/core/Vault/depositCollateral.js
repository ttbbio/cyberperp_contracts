...
describe("Vault.depositCollateral", function () {
  ...
  it("deposit collateral", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("93717000000000000000") // 93.7182
    expect(await cyberLPManager.getAumInUsdg(true)).eq("93717000000000000000") // 95.33498
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("109884500000000000000") // 109.886
    expect(await cyberLPManager.getAumInUsdg(true)).eq("109884500000000000000") // 111.50278
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("109884500000000000000") // 109.886
    expect(await cyberLPManager.getAumInUsdg(true)).eq("109884500000000000000") // 111.50378
