...
describe("Vault.liquidateShortPosition", function () {
  ...
  it("liquidate short", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("99960000000000000000") // 99.96
    ...
    expect(await vault.globalShortSizes(btc.address)).eq(0)
    expect(await vault.globalShortAveragePrices(btc.address)).eq(toNormalizedPrice(40000))
    expect(await cyberLPManager.getAumInUsdg(true)).eq("104780000000000000000") // 104.78
  ...
  it("automatic stop-loss", async () => {
    ...
    expect(await vault.globalShortAveragePrices(btc.address)).eq(toNormalizedPrice(40000))
    expect(await cyberLPManager.getAumInUsdg(false)).eq("1000599600000000000000") // 1000.5996
    ...
    expect(await vault.globalShortSizes(btc.address)).eq(toUsd(1000))
    expect(await vault.globalShortAveragePrices(btc.address)).eq(toNormalizedPrice(40000))
    expect(await cyberLPManager.getAumInUsdg(true)).eq("1090599600000000000000") // 1090.5996
  ...
  it("global AUM", async () => {
    ...
    expect(await vault.globalShortSizes(btc.address)).eq(toUsd(1000))
    expect(await vault.globalShortAveragePrices(btc.address)).eq(toNormalizedPrice(40000))
    expect(await cyberLPManager.getAumInUsdg(true)).eq("1125599600000000000000") // 1125.5996
    ...
    expect(await vault.globalShortSizes(btc.address)).eq(0)
    expect(await vault.globalShortAveragePrices(btc.address)).eq(toNormalizedPrice(40000))
    expect(await cyberLPManager.getAumInUsdg(true)).eq("1093599600000000000000") // 1093.5996
