...
describe("Vault.decreaseShortPosition", function () {
  ...
  it("decreasePosition short", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 0").eq("99960000000000000000") // 99.96
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 0").eq("99960000000000000000") // 99.96
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 1").eq("99960000000000000000") // 99.96
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 1").eq("99960000000000000000") // 102.21
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 2").eq("9962250000000000000") // 9.96225
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 2").eq("9962250000000000000") // 9.96225
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 3").eq("9962250000000000000") // 9.96225
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 3").eq("9962250000000000000") // 9.96225
  ...
  it("decreasePosition short minProfitBasisPoints", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 4").eq("99960000000000000000") // 99.96
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 4").eq("99960000000000000000") // 99.96

    await dai.connect(user0).transfer(vault.address, expandDecimals(10, 18))
    await vault.connect(user0).increasePosition(user0.address, dai.address, btc.address, toUsd(90), false)

    expect(await cyberLPManager.getAumInUsdg(false), "aum min 5").eq("99960000000000000000") // 99.96
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 5").eq("99960000000000000000") // 102.21
    ...
    await pyth.updatePrice(priceFeedIds.btc, toChainlinkPrice(39701)) // 40,000 * (100 - 0.75)% => 39700
    await pyth.updatePrice(priceFeedIds.btc, toChainlinkPrice(39701))
    await pyth.updatePrice(priceFeedIds.btc, toChainlinkPrice(39701))
    let delta = await vault.getPositionDelta(user0.address, dai.address, btc.address, false)
    expect(delta[0]).eq(true)
  ...
  it("decreasePosition short with loss", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 6").eq("99960000000000000000") // 99.96
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 6").eq("99960000000000000000") // 99.96

    await dai.connect(user0).transfer(vault.address, expandDecimals(10, 18))
    await vault.connect(user0).increasePosition(user0.address, dai.address, btc.address, toUsd(90), false)

    expect(await cyberLPManager.getAumInUsdg(false), "aum min 7").eq("99960000000000000000") // 99.96
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 7").eq("99960000000000000000") // 102.21
    ...
    await pyth.updatePrice(priceFeedIds.btc, toChainlinkPrice(40400))
    await pyth.updatePrice(priceFeedIds.btc, toChainlinkPrice(40400))
    await pyth.updatePrice(priceFeedIds.btc, toChainlinkPrice(40400))
    let delta = await vault.getPositionDelta(user0.address, dai.address, btc.address, false)
    expect(delta[0]).eq(false)
    ...
    expect(await cyberLPManager.getAumInUsdg(false), "aum min 7").eq("100860000000000000000") // 100.86
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 7").eq("100860000000000000000") // 100.86

    await vault.connect(user0).decreasePosition(user0.address, dai.address, btc.address, toUsd(0), toUsd(50), false, user2.address)

    expect(await cyberLPManager.getAumInUsdg(false), "aum min 8").eq("100860000000000000000") // 100.86
    expect(await cyberLPManager.getAumInUsdg(true), "aum max 8").eq("100860000000000000000") // 100.86
