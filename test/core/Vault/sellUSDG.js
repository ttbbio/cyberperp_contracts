...
describe("Vault.sellUSDG", function () {
  ...
  it("sellUSDG", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(29700)
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(29700 - 15000)
  })
  ...
  it("sellUSDG after a price increase", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq(49500)
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq(34500)
  })
  ...
  it("sellUSDG redeem based on price", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq("119640000000000000000000") // 119,640
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("165502000000000000000000") // 199400000 / (10 ** 8) * 80,000
    ...
    expect(await cyberLPManager.getAumInUsdg(false)).eq("155502000640000000000000") // 149881.4464, 187351808 / (10 ** 8) * 80,000
  })
  ...
  it("sellUSDG for stableTokens", async () => {
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(expandDecimals(9996, 18))
    ...
    expect(await cyberLPManager.getAumInUsdg(true)).eq(expandDecimals(5996, 18))
  })
})
