...
const { deployContract, deployTimeDistributor, deployVault, deployProxyBlockInfo, deployVaultPriceFeed, deployCyberLPManager, deployTimelock } = require("../shared/fixtures")
...
let pyth;
  ...
  describe("Updates short tracker data", () => {
    ...
    it("executeDecreasePosition", async () => {
      ...
      expect(await cyberLPManager.getAum(true), "aum 0").to.be.closeTo(aumBefore, 100)
      ...
      expect(await cyberLPManager.getAum(true), "aum 1").to.be.closeTo(aumBefore, 100)
    })
  })
})
