...
export default async function main() {
    ...
    // const ethPythPriceFeedV2 = await deployContract( "PythPriceFeedV2", [config.pyth, ethPriceFeedId, age], "ethPythPriceFeedV2");
    // const btcPythPriceFeedV2 = await deployContract( "PythPriceFeedV2", [config.pyth, btcPriceFeedId, age], "btcPythPriceFeedV2");
    // const usdcPythPriceFeedV2 = await deployContract( "PythPriceFeedV2", [config.pyth, usdcPriceFeedId, age], "usdcPythPriceFeedV2");
